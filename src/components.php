...
RouteRepository::registerRoute('GET', '/funds/add', Funds::class, 'add');
RouteRepository::registerRoute('POST', '/funds/add', Funds::class, 'addPost');

Menu::register(LoginMenu::class, 100);
Menu::register(RegisterMenu::class, 200);
Menu::register(AccountMenu::class, 200);
Menu::register(AddFundsMenu::class, 300);
